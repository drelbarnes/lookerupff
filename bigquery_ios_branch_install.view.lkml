view: bigquery_ios_branch_install {
  sql_table_name: ios.branch_install ;;
  ...
  dimension: click_to_conversion_cohort {
    type: string
    sql: ${TABLE}.click_to_conversion_cohort ;;
  }

  dimension: click_to_install_cohort {
    type: string
    sql: ${TABLE}.click_to_install_cohort ;;
  }

  dimension: click_to_session_cohort {
    type: string
    sql: ${TABLE}.click_to_session_cohort ;;
  }

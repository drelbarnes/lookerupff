view: redshift_android_application_installed {
  sql_table_name: android.application_installed ;;
  ...
  measure: count {
    type: count
    drill_fields: [id, context_library_name, context_os_name, context_app_name, context_device_name]
  }
}

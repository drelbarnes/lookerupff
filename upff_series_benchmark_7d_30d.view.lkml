    ...
    derived_table: {
      sql:    with
              ...
              SELECT
                ...
                , e.title
                , CASE WHEN CURRENT_DATE > DATEADD(day, 7, drop_date) THEN 'y' ELSE 'n' END AS finalized_7d
                , CASE WHEN CURRENT_DATE > DATEADD(day, 30, drop_date) THEN 'y' ELSE 'n' END AS finalized_30d

    ...
    sql: SELECT *
      ...
      UNNEST(
        [
          ...
          , struct('test5@bogo.com' as email, 5 as user_id, "test" as first_name, "5" as last_name, "enabled" as subscription_status, "monthly" as frequency, "customer.product.updated" as topic, FALSE as moptin, "android" as platform, "upff" as vod_brand, TRUE as test_user)

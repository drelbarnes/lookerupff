view: checkout_pages2 {
  derived_table: {
    ...
    COUNT(DISTINCT CASE
      WHEN (checkout_pages.context_page_path LIKE '%gaither%'
  ...
  {% endif %}
    COUNT(DISTINCT CASE
          WHEN (checkout_pages.context_page_path IN ('/index.php/welcome/plans', '/','/index.php/welcome/plans/gaithertvplus'))
          THEN checkout_pages.context_ip
          ELSE NULL
    ...
    COUNT(DISTINCT CASE
      WHEN (checkout_pages.context_page_path LIKE '/index.php/welcome/up_sell' OR checkout_pages.context_page_path LIKE '/index.php/welcome/up_sell/gaithertvplus/monthly' OR checkout_pages.context_page_path LIKE '/index.php/welcome/up_sell/gaithertvplus/yearly' OR checkout_pages.context_page_path LIKE '/up_sell') AND (checkout_pages.data_table  = 'order_completed')
      THEN checkout_pages.context_ip
      ELSE NULL

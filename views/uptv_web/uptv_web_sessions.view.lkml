  ...
  dimension: marketing_platform {
    sql: CASE
            ...
            WHEN LOWER(${source}) = 'cj_uptv'
              then 'CJ'
            WHEN LOWER(${source}) = 'www.mostupliftingchristmas.com'
              or LOWER(${source}) = 'mostupliftingchristmas.com'
              or LOWER(${source}) = 'mostupliftingchristmas'
              then 'mostupliftingchristmas'
            WHEN LOWER(${source}) = 'https://app.uptv.com'
              or LOWER(${source}) = 'app.uptv.com'
              or LOWER(${source}) = 'app.uptv'
              then 'appuptv'

view: uptv_page_events {
    ...
    sql: CREATE TEMP FUNCTION URLDECODE(url STRING) AS ((
      ...
      , campaign_session_mapping_p1 as (
        ...
        , case
          ...
          when utm_campaign is null and (referrer_domain is not null and referrer_domain != "uptv.com") then 1
          else 0
  ...
  dimension: campaign_source {
    sql: CASE
      WHEN ${TABLE}.utm_source is null and ${TABLE}.referrer_domain is null or ${TABLE}.referrer_domain = "uptv.com/" then "unknown"
      WHEN ${TABLE}.utm_source is null and ${TABLE}.referrer_domain is not null and ${TABLE}.referrer_domain != "uptv.com/" then ${TABLE}.referrer_domain

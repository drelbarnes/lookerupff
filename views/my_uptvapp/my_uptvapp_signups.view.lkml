view: my_uptvapp_signups {
  ...
  measure: total_distinct_emails_opt_in {
    type: count_distinct
    sql: ${email} ;;
    description: "number of distinct email with opt in."
  ...
  measure: total_distinct_user_email_opt_in {
    type: count_distinct
    sql: ${user_email} ;;
    description: "number of distinct user emails with opt in"
    filters: [opt_in_communications: "yes"]
    drill_fields: [opt_in_communications]
  }
  ...
  measure: total_opt_ins {
    type: number
    sql: ${total_distinct_emails_opt_in}+${total_distinct_user_email_opt_in} ;;

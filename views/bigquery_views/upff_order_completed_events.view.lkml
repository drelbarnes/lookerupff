view: upff_order_completed_events {
  derived_table: {
    sql:
      ...
      , web_events as (
      -- The Vimeo OTT user id is the value for context_traits_vimeo_id, the Chargebee Customer ID is the value for user_id.
      select
      anonymous_id, "UP Entertainment Checkout" as context_app_name, cast(null as string) as context_app_version, cast(null as string) as context_app_build, cast(null as string) as context_app_namespace, cast(null as boolean) as context_device_ad_tracking_enabled, cast(null as string) as context_device_advertising_id, cast(null as string) as context_device_id, cast(null as string) as context_device_manufacturer, cast(null as string) as context_device_model, cast(null as string) as context_device_name, cast(null as string) as context_device_type, context_locale, cast(null as string) as context_network_carrier, cast(null as boolean) as context_network_cellular, cast(null as boolean) as context_network_wifi, cast(null as string) as context_os_name, cast(null as string) as context_os_version, cast(null as int) as context_screen_height, cast(null as int) as context_screen_width, context_timezone, context_ip, cast(null as string) as context_external_ids, context_library_name, context_library_version, user_email as context_traits_email, first_name || ' ' || last_name as context_traits_name, cast(entitlements_ott_user_id as string) as context_traits_vimeo_id, cast(entitlements_product_id as string) as context_transaction_product_id, context_user_agent, cast(null as string) as conversion_type, "web" as device, cast(null as string) as device_id, event, event_text, order_id as id, loaded_at, event_text as name, original_timestamp, "web" as platform, cast(null as string) as platform_id, cast(null as string) as platform_version, cast(entitlements_product_id as int) as product_id, received_at, sent_at, cast(checkout_id as string) as session_id, cast(null as int) as site_id, timestamp, cast(null as string) as type, user_email, cast(user_id as string) as customer_id, uuid_ts, cast(null as string) as view
      , b.ott_user_id as user_id

view: upff_order_completed_events {
  ...
  dimension: event_id {
    type: string
    sql: to_hex(sha1(concat(${TABLE}.id,safe_cast(${TABLE}.timestamp as string)))) ;;
  }

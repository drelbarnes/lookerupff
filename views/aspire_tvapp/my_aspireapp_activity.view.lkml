view: my_aspireapp_activity {

    sql_table_name: aspire_app.application_opened ;;
    ...
    measure: total_distinct_opens {
      type: count_distinct
      sql: ${anonymous_id} ;;
      description: "my_aspireapp_installs_total_active_users"
    }

view: vimeo_webhook_events {
  derived_table: {
    sql: with purchase_events as (
      ...
      union all
      select timestamp_add(timestamp, interval 1 minute) as timestamp, user_id, event, campaign, city, country, created_at, email, first_name, last_name, last_payment_date, marketing_opt_in, name, next_payment_date, plan, platform, promotion_code, referrer, region, registered_to_site, source, subscribed_to_site, subscription_frequency, subscription_price, subscription_status, updated_at
      ...
      union all
      select timestamp, user_id, event, campaign, city, country, created_at, cast(null as string) as email, cast(null as string) as first_name, cast(null as string) as last_name, last_payment_date, marketing_opt_in, cast(null as string) as name, next_payment_date, plan, platform, promotion_code, referrer, region, registered_to_site, source, subscribed_to_site, subscription_frequency, subscription_price, subscription_status, updated_at

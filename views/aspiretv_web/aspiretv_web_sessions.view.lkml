  ...
  dimension: marketing_platform {
    sql: CASE
            WHEN LOWER(${source}) = 'hs_email'
              ...
              or LOWER(${source}) = 'ASO Communications'
              then 'HubSpot'
            ...
            WHEN LOWER(${source}) = 'aspiretv-linear'
              ...
              or LOWER(${source}) = 'linear_aspire'
              then 'aspiretv Linear'
            WHEN LOWER(${source}) = 'freebieshark.com'
              or LOWER(${source}) = 'contestgirl.com'
              or LOWER(${source}) = 'hypersweep.com'
              or LOWER(${source}) = 'freeprizesonline.com'
              or LOWER(${source}) = 'nikkisfreebiejeebies.com'
              or LOWER(${source}) = 'freestufftimes.com'
              or LOWER(${source}) = 'sweepgrab.com'
              or LOWER(${source}) = 'sweepadvantage.com'
              or LOWER(${source}) = 'sweepsatlas.com'
              or LOWER(${source}) = 'sweepsheet.com'
              or LOWER(${source}) = 'sweepstake.com'
              or LOWER(${source}) = 'sweepstakesbible.com'
              or LOWER(${source}) = 'sweepstakesfanatics.com'
              or LOWER(${source}) = 'sweepstakesplus.com'
              or LOWER(${source}) = 'sweepstakestoday.com'
              or LOWER(${source}) = 'sweetiessecrets.com'
              or LOWER(${source}) = 'ultracontest.com'
              or LOWER(${source}) = 'pch.com'
              then 'Online Sweepstakes'
            WHEN LOWER(${source}) = 'aspiretv_movies_app'
              ...
              or LOWER(${source}) = 'butterandbrown.com'
              then 'aspiretv Digital'
            WHEN LOWER(${source}) = 'zendesk'
              or LOWER(${source}) = 'support'
              then 'Customer Support'
            WHEN LOWER(${source}) = 'upentertainment.com'
              or LOWER(${source}) = 'upliftsomeone.com'
              or LOWER(${source}) = 'uptv.com'
              or LOWER(${source}) = 'uptv_hs'
              then 'Cross Promotion'
            WHEN LOWER(${source}) = 'google.com'
              or LOWER(${source}) = 'android.gm'
              or LOWER(${source}) = 'google.ca'
              or LOWER(${source}) = 'google.co.id'
              or LOWER(${source}) = 'google.co.uk'
              or LOWER(${source}) = 'google.com.hk'
              or LOWER(${source}) = 'bing.com'
              or LOWER(${source}) = 'yahoo.com'
              or LOWER(${source}) = 'duckduckgo.com'
              or LOWER(${source}) = 'aol.com'
              or LOWER(${source}) = 'msn.com'
              or LOWER(${source}) = 'imdb.com'
              then 'Organic Search'
            WHEN LOWER(${source}) = 'facebook.com'
              or LOWER(${source}) = 'instagram.com'
              or LOWER(${source}) = 'twitter.com'
              or LOWER(${source}) = 'x.com'
              or LOWER(${source}) = 'tiktok.com'
              or LOWER(${source}) = 't.co'
              or LOWER(${source}) = 'youtube.com'
              or LOWER(${source}) = 'linkedin.android'
              or LOWER(${source}) = 'linkedin.com'
              or LOWER(${source}) = 'linktr.ee'
              or LOWER(${source}) = 'pinterest.com'
              then 'Organic Social'
            WHEN LOWER(${source}) = 'mntn_aspire'
              then "MNTN"
            WHEN LOWER(${source}) = 'banners'
              then "Banners"

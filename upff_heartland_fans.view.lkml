view: upff_heartland_fans {
      ...
      sql: with
                    ...
                    SELECT
                      *
                      ...
                      , CASE WHEN collection = 'Heartland - Season 18' THEN 1 ELSE 0 END AS hl_s18_flag
                    ...
                    SELECT
                      ...
                      , sum(hl_s18_flag) as sum_hl_s18_flag
                    ...
                    SELECT
                      ...
                      , c.content_customer_phone
                      , c.content_customer_cs_marketing_opt_in
                    FROM audience_view_flags AS a
                    LEFT JOIN customers_updated_event AS b
                    ON a.user_id = b.user_id
                    LEFT JOIN chargebee_webhook_events.subscription_created AS c
                    ON b.email = c.content_customer_email
                    ),
    ...
    dimension: content_customer_phone {
      type: string
      sql: ${TABLE}.content_customer_phone ;;
    }

    dimension: content_customer_cs_marketing_opt_in {
      type: string
      sql: ${TABLE}.content_customer_cs_marketing_opt_in ;;
    }
    ...
    set: detail {
      fields: [
        ...
        subscription_status,
        content_customer_phone,
        content_customer_cs_marketing_opt_in
      ]
    }
  }

view: heartland_s16_tenure_analysis {
    derived_table: {
      sql: with
        ...
        *,
        ...
        a.*,
        b.paid_months,
        case when paid_months < (tenure - 3) then 'yes' else 'no' end as lapse
        from list_c as a
    ...
    dimension: heartland_season_16 {
      type: number
      sql: ${TABLE}.heartland_season_16 ;;
    }

view: redshift_allfirstplay_javascript_video_content_playing {
  derived_table: {
    sql:
...
select
  ...
  end_date,
  case
    when collection in ('Season 1','Season 2','Season 3')
    then series || ' ' || collection
    else collection
  end as collection,
  case

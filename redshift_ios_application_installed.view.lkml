view: redshift_ios_application_installed {
  sql_table_name: ios.application_installed ;;
  ...
  measure: count {
    type: count
    drill_fields: [id, context_app_name, context_library_name, context_os_name, context_traits_name]
  }
}

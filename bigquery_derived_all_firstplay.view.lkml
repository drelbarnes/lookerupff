  ...
  derived_table: {
    sql: (with a as
        (select a.timestamp,
                ...
                b.platform,
                'Android' as source
         from android.firstplay as a left join customers.subscribers as b
         ...
         select a.timestamp,
                ...
                b.platform,
                'iOS' as source
         from ios.firstplay as a left join customers.subscribers as b
         on SAFE_CAST(a.user_id AS INT64) = b.customer_id
         union all
         select a.timestamp,
                user_id,
                b.platform,
                'Web' as source
         from javascript.firstplay as a left join customers.subscribers as b
         on SAFE_CAST(a.user_id AS INT64) = b.customer_id
        )

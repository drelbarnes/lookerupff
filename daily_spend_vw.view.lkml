...
WHERE g.name in ('RMG_Google Search-Heartland Season 18',
    'RMG_Youtube_Core Audience_Brand Message',
    'RMG_Youtube_Core Audience_TCPA_2025',
    'RMG_UPFF_Full Funnel_Search_Google_2026_Branded',
    'RMG_UPFF_Full Funnel_Search_Google_2025_Hudson And Rex',
    'RMG_Youtube_Core Audience_DemandGen_2025')
     ...
     customers_analytics as (
      ...
      group by apr.date_start, b.spend
      ),
      others_perf as (
      with p0 as (
